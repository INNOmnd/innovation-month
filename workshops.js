...
(function () {
  ...
  const WORKSHOPS = [
    ...
    // Donderdag 06-11
    { id:'ongemakkenjacht-4', title:'Innovatie Jacht', date:`${currentYear}-11-06`, start:'10:00', end:'12:00', speaker:'Amy & Wendy', banner:'pictures/ongemakkenjacht.png', desc:'Ongemakkenjacht in het Werkhuis (10 personen).',bannerFit:'cover', status: "", descFile:'descriptions/ongemakkenjacht.html' },
    ...
    { id:'dwam', title:'Drone With A Mission', date:`${currentYear}-11-13`, start:'11:00', end:'13:00', speaker:'Ruud Janssen', banner:'pictures/dwam.png', desc:'Inzet van drones voor inspecties, vastgoedbeheer en bouw – met demo’s en praktijkvoorbeelden.',bannerFit:'cover', status: "", descFile:'descriptions/dwam.html' },
    { id:'wrk-ai-intermediate', title:'Werken met AI Gevorderd', date:`${currentYear}-11-13`, start:'13:00', end:'15:00', speaker:'Job', banner:'pictures/werken-met-ai-gevorderd.jpg', desc:'Werken met AI in het Werkhuis (10 personen).',bannerFit:'cover', status: "", descFile:'descriptions/wrk-ai-intermediate.html' },
    { id:'digital-twin', title:'Digital Twin', date:`${currentYear}-11-13`, start:'15:00', end:'17:00', speaker:'BIM - Dirk Jan & Wouter', banner:'pictures/digital-twin.svg', desc:'Digital Twin',bannerFit:'', status: "", descFile:'descriptions/digital-twin.html' },
    { id:'tips1', title:'Outlook Tips & Tricks 1', date:`${currentYear}-11-13`, start:'10:00', end:'12:00', speaker:'Valesca & Debbie', banner:'pictures/tips1.jpeg', desc:'Office tips & tricks',bannerFit:'cover', status: "", descFile:'descriptions/tips.html' },
    ...
    { id:'tips2', title:'Outlook Tips & Tricks 2', date:`${currentYear}-11-18`, start:'09:00', end:'11:00', speaker:'Valesca & Debbie', banner:'pictures/tips1.jpeg', desc:'Office tips & tricks',bannerFit:'cover', status: "", descFile:'descriptions/tips.html' },
    ...
    { id:'vr-x4-2', title:'VR beleving dementie Into D\'mentia', date:`${currentYear}-11-25`, start:'09:30', end:'10:30', speaker:'Ideon', banner:'pictures/vr-x4.png', desc:'VR? x 4 in Huis vd Toekomst (6 personen).',bannerFit:'', status: "", descFile:'descriptions/vr-x4.html' },
    { id:'vr-x4-3', title:'VR beleving dementie Into D\'mentia', date:`${currentYear}-11-25`, start:'10:45', end:'11:45', speaker:'Ideon', banner:'pictures/vr-x4.png', desc:'VR? x 4 in Huis vd Toekomst (6 personen).',bannerFit:'', status: "", descFile:'descriptions/vr-x4.html' },
    { id:'vr-x4-4', title:'VR beleving dementie Into D\'mentia', date:`${currentYear}-11-25`, start:'11:45', end:'12:45', speaker:'Ideon', banner:'pictures/vr-x4.png', desc:'VR? x 4 in Huis vd Toekomst (6 personen).',bannerFit:'', status: "", descFile:'descriptions/vr-x4.html' },
    { id:'zig-ai', title:'ZIG & AI', date:`${currentYear}-11-25`, start:'09:00', end:'11:00', speaker:'ZIG', banner:'pictures/zig.gif', desc:'ZIG & AI in het Werkhuis (16 personen).',bannerFit:'cover', status: "", descFile:'descriptions/zig-ai.html' },
    { id:'goeie-buurtaal-ai2', title:'Goeie Buurtaal met AI', date:`${currentYear}-11-25`, start:'11:00', end:'13:00', speaker:'Amy en Wendy', banner:'pictures/goeie-buurtaal-ai.png', desc:'Goeie Buur-taal in het Werkhuis (10 personen).',bannerFit:'', status: "", descFile:'descriptions/goeie-buurtaal-ai.html' },
